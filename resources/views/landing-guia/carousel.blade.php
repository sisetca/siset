    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
         <img src="{{ asset('/la-assets/img/landing/carousel_red.png') }}" alt="Awesome Image">
          
        </div>
        <div class="item">
        <img src="{{ asset('/la-assets/img/landing/carousel_green.png') }}" alt="Awesome Image">
          
        </div>
        <div class="item">
        <img src="{{ asset('/la-assets/img/landing/carousel_blue.png') }}" alt="Awesome Image">
